-- Planos
-- Enterprise usa price_cents = 0 (preço sob consulta; negociado via backoffice)
INSERT INTO subscription_plans (id, code, name, active, billing_cycle, currency, price_cents) VALUES
  ...
  ('20000000-0000-0000-0000-000000000004', 'enterprise', 'Enterprise', TRUE, 'monthly', 'BRL',      0)
ON CONFLICT (id) DO NOTHING;

-- Features do plano Free
-- limit_value: número máximo de registros; NULL = sem limite
-- trial_enabled: feature disponível por trial_days dias mesmo estando desabilitada no plano
...
-- Features do plano Enterprise (sem limites, todas as features habilitadas)
INSERT INTO plan_features (id, plan_id, feature_key, enabled, limit_value, trial_enabled, trial_days) VALUES
